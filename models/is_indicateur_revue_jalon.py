...
class is_indicateur_revue_jalon(models.Model):
    ...
    cycle_par_piece1            = fields.Integer('Cycle par pièce')
    cycle_par_piece2            = fields.Integer('Cycle par pièce')
    mod1                        = fields.Float('MOD')
    mod2                        = fields.Float('MOD')
    tx_rebut_vendu1             = fields.Integer('Tx rebut vendu')
    tx_rebut_vendu2             = fields.Integer('Tx rebut vendu')
    poids_piece1                = fields.Integer('Poids pièce (en g)')
    poids_piece2                = fields.Integer('Poids pièce (en g)')
    poids_carotte1              = fields.Integer('Poids carotte (en g)')
    poids_carotte2              = fields.Integer('Poids carotte (en g)')
